...
const Contact = () => {
  ...
  const sendEmail = () => {
    ...
    emailjs
      .sendForm("service_a1tii3f", "template_3w6959g", form.current, {
                            ...
                            <div className="col-md-12 mb-3 d-flex me-5">
                              ...
                              <div className="">
                                <span className="check-box-text">
                                  ...
                                  STOP to the received SMS (texts) or clicking
                                  the unsubscribe link (where available) in the
                                  ...
                                  information. Any information you provide
                                  through opt-in consent will not be shared with
                                  third parties for marketing or promotional
                                  purposes.
                                </span>
                              </div>
                            </div>
